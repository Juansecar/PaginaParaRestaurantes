...
<html lang="en">
  ...
  <head>
    ...
    <title>Administración de Empleados - Pensilvania-Caldas</title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.php">Restaurante | Pensilvania-Caldas</a>
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Sistema de Restaurante Pensilvania-Caldas 2022</span>
            </div>
          </div>
        </footer>
